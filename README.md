...
- The number of **freight vehicles and tractors** dropped significantly during the **2008 financial crisis**, and has not recovered ever since, with another significant drop in 2019.
...
- As off **2003**, we can see that the Bratislava District dominates in terms of the number of passenger cars per 100 inhabitants
  - The **Bratislava** District: **36 cars / 100 people**
  - The rest of **Slovakia** (average): **18 cars / 100 people**
...
- 21 years later in **2024**, the trend remains, with the Bratislava Distrtict leading sifnicantly and the rest of Slovakia falling about 15 years behind the trend
  - The **Bratislava** District: **76 cars / 100 people**
  - The rest of **Slovakia** (average): **47 cars / 100 people**
...
- An interesting phenomenon of increases in the number of passenger cars can be observed in **the east of Slovakia**, namely in the Sobrance District and to a lesser extent in the Michalovce District. My guess is that it might have to do with cars being exported to Ukraine. It has been a common practice for many Ukrainians to buy cars in European countries.
...
<img width="1392" height="728" alt="Change in Cars per 1000 inhabitants by district in 2024 (map)" src="https://github.com/user-attachments/assets/6d0fdbac-63b5-46a2-86bb-d85270714d66" />
<br/>
<br/>
<br/>
...
## Passenger Cars per 100 inhabitants vs Unemployment Rate
- Ditricts with **higher unemployment** rates tend to have **less cars** per 100 people, although the impact of unemployment seems to be more significant now (2024) than in the past (2003).
- In 2003, unemployement does not seem to have been a major factor affecting the number of cars per 100 inhabitants of a district.
<img width="1084" height="611" alt="Cars per 100 inhabitants vs Unemployment Rate" src="https://github.com/user-attachments/assets/7a6edae8-dea3-4158-a6b7-260cc29d47c5" />
<br/>
<br/>
<br/>

## Passenger Cars per 100 inhabitants vs Household Size
- The hypothesis was that the more people in a household, the higher the need for car.
- However, in Slovakia this seems to be the contrary – **the greater the average household size of a region, the smaller number of passenger cars per 100 inhabitants**.
- My guess is that this is because the average household size goes hand in hand with income.
- In Slovakia, regions with **socially excluded communities** with low income tend to be the ones, in which one household accommodates more people than elsewhere. 
<img width="1079" height="611" alt="Cars per 100 inhabitants vs Household Size" src="https://github.com/user-attachments/assets/8acbdb2b-828e-47cc-bc7c-6420116f9dd1" />
<br/>
<br/>
<br/>
